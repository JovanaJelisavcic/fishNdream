...
insert into fisherman (EMAIL, ADDRESS, CITY, NAME, PHONE_NUM, STATE, SURNAME, deleted) values ('jovana.jelisavcic95@gmail.com', 'Picaso Street 85', 'Bilbao', 'Spain', 'Clara', '551-815-989', 'Bonifaces', false);
...
insert into boat (BOAT_ID,	ADDRESS, BEHAVIOUR_RULES, CANCEL_POLICY, CAPACITY, DESCRIPTION, ENGINE_NUM, ENGINE_POWER, LENGTH, MAX_SPEED, NAME, BOAT_TYPE, OWNER_EMAIL) values
 (1, 'Zlatibor', 'No smoking', true, 12, 'Beautiful and fast', 2, 152, 12.5, 45, 'Ursel', 'gliser',  'petarv7@gmail.com' );
...
values (1, '2021-12-28T12:00:00', false, '2021-12-28T14:00:00', 10, 250, 1, null, true, '2021-11-20T14:00:00', '2021-12-30T15:00:00');
...
insert into reservation_boat (RESERVATION_ID, BEGINNING, CANCELED, ENDING, participants_num, PRICE, BOAT_ID, EMAIL, action_res, action_start_time, action_end_time )
values (2, '2021-10-29T12:00:00', false, '2021-10-30T14:00:00', 10, 250, 1, 'jovana.jelisavcic95@gmail.com', true, '2021-11-17T14:00:00', '2021-11-25T14:00:00');

 insert into boat (BOAT_ID,	ADDRESS, BEHAVIOUR_RULES, CANCEL_POLICY, CAPACITY, DESCRIPTION, ENGINE_NUM, ENGINE_POWER, LENGTH, MAX_SPEED, NAME, BOAT_TYPE, OWNER_EMAIL) values
 (2, 'Tara', 'No pets', false, 12, 'Beautiful and fast', 2, 152, 12.5, 45, 'Kalina', 'ferry',  'petarv7@gmail.com' );
 insert into AVAILABILITY_PERIOD_BOATS  (PERIOD_ID, BEGGINING, ENDING,BOAT_ID ) values
...
values (1, '2021-10-22T12:00:00', false, '2021-10-24T14:00:00', 5, 150, 1,'jovana.jelisavcic95@gmail.com' , true, '2021-11-19T14:00:00','2021-12-20T14:00:00' );
...
insert into users (user_id,username, password, enabled, deleted, verification_code) values (2,'jovana.jelisavcic95@gmail.com', '$2a$10$Fh4qeAY.sD6A/BdTBl8g6e5iYh8scygIZcAbT1iUpisI.qHhYdgR2', true, false, null);
